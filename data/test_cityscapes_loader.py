...
def test_db():
    ...
    db = csl.CityscapesDB('/data/cityscapes','training',16)
    print("Instantiated DB")
    print("Getting IDs")
    print(db.get_ids())
    print("Gotten IDs")
    print("Getting sample")
    v,l = db.get_sample(list(range(len(db.get_ids())))[0])
    print(v)
    print(l)
    print(v.shape)
    print(l.shape)
...
def test_dataset():
    ...
    ds = csl.CityscapesDataset('/data/cityscapes','training',16, None, None)
...
def test_dataloader():
    ...
    dl = DataLoader(csl.CityscapesDataset('/data/cityscapes','training',16, transform, None),
