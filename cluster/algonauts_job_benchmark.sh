...
#SBATCH --gres=gpu:1						# Query two GPUs on the node
#SBATCH --mem=128000mb						# Necessary RAM
...
cd ${JOB_DIR}
singularity exec --nv --bind $(pwd):/mnt --bind ${ALGONAUTS_WS}/data:/data/ --pwd /mnt ${SINGULARITY_CONTAINER} python3 -m benchmark -n 16 --bsize 32
