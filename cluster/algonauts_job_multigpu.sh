...
#SBATCH --gres=gpu:3						# Query two GPUs on the node
#SBATCH --mem=64000mb						# Necessary RAM
...
cd ${JOB_DIR}
singularity exec --nv --bind $(pwd):/mnt --bind ${ALGONAUTS_WS}/data:/data ${SINGULARITY_CONTAINER} python3 /mnt/train_model.py -b 1000 --loginterval 10 --ckptinterval 10
